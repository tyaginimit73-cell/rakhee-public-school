...
import {
  UserRound, CalendarCheck, FileText, Wallet, Megaphone, FolderOpen,
  GraduationCap, ChevronRight, FileDown, MapPin,
} from 'lucide-react';
...
// Same tab content that originally lived inline in PortalDashboard.jsx —
// moved here unchanged (logic and styling both) so it can be used from
// both the student portal (renders it once, for the account's own
// record) and the parent portal (renders it for whichever child is
// currently selected) without keeping two copies in sync by hand.
export default function StudentInfoPanel({ data }) {
